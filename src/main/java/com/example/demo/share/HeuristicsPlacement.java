...
public class HeuristicsPlacement {
    ...
    public boolean HAcomodo(Sheet objeto, Piece pieza, String Heur_Acom) {
        ...
        else if (Heur_Acom.equals("MA")) acomodo = MAHeuristic(objeto, pieza);
        else if (Heur_Acom.equals("MABR")) acomodo = MAHeuristicBR(objeto, pieza);
        else if (Heur_Acom.equals("MALBR")) acomodo = MAHeuristicLBR(objeto, pieza);
    ...
    private boolean EC2Heuristic(Sheet objeto, Piece pieza) {
        ...
        for (int i = 0; i < rotaciones.size(); i++) {
            ...
            for (int[] listapunto : listapuntos) {
                posicion = listapunto;
                pieza.moveToXY(posicion[0], posicion[1], 2);
    ...
    private boolean runIntoBottomLeftPlacement(Sheet objeto, Piece pieza) {
        ...
        } while ((distHorizontal > 0 && distHorizontal < numgrande) || (distVertical > 0 && distVertical < numgrande));

        return xpos != pieza.getXmin() || ypos != pieza.getYmin();
    }
    ...
    private static PieceVirtual piezaIzq(Piece pza) {
        ...
        if (puntos == 4) {
            int[] coordenadas = {0, punto1[1], 0, punto2[1], punto2[0], punto2[1], punto1[0], punto1[1]};
            pzatemp = new PieceVirtual(coordenadas);
        } else if (puntos == 5) {
            int[] coordenadas = {0, punto1[1], 0, punto2[1], punto2[0], punto2[1], coord1[vert1 + 1], coord2[vert1 + 1], punto1[0], punto1[1]};
            pzatemp = new PieceVirtual(coordenadas);
        } else {
            int[] coordenadas = new int[puntos * 2];
            coordenadas[0] = 0;
    ...
    private static PieceVirtual piezaRight(Piece pza) {
        ...
        if (puntos == 4) {
            int[] coordenadas = {punto1[0], punto1[1], punto2[0], punto2[1], 1000, punto2[1], 1000, punto1[1]};
            pzatemp = new PieceVirtual(coordenadas);
        } else if (puntos == 5) {


            int[] coordenadas = {1000, punto2[1], 1000, punto1[1], punto1[0], punto1[1], coord1[vert2 + 1], coord2[vert2 + 1], punto2[0], punto2[1]};
            pzatemp = new PieceVirtual(coordenadas);
        } else {
    ...
    public static int cercaniaHorOP(Sheet objeto, Piece piezaOut) {
        ...
        if (pzasInside.isEmpty()) {
            ...
            for (int i = 0; i < pzasInside.size(); i++) {
                pzaIn = pzasInside.get(i);
                if ((interseccionPPV(pzaIn, pzatemp) || dentroPPV(pzaIn, pzatemp)) && !interseccionPP(pzaIn, piezaOut) && !dentroPP(pzaIn, piezaOut)) {
                    pzasIzq.add(pzaIn);
                }
            }
    ...
    private static int cercaniaHorPP(Piece pieza1, Piece pieza2) {
        ...
        for (i = 0; i < vertices1; i++) {
            for (j = 0; j < vertices2 - 1; j++) {
                dist = -SegmentoPuntoH(pieza1.coordX[i], pieza1.coordY[i], pieza2.coordX[j], pieza2.coordY[j], pieza2.coordX[j + 1], pieza2.coordY[j + 1]);
                if (dist < 0) {
                    continue;
                }
        ...
        for (i = 0; i < vertices1; i++) {
            dist = -SegmentoPuntoH(pieza1.coordX[i], pieza1.coordY[i], pieza2.coordX[vertices2 - 1], pieza2.coordY[vertices2 - 1], pieza2.coordX[0], pieza2.coordY[0]);
            if (dist < 0) {
                continue;
            }
        ...
        for (i = 0; i < vertices2; i++) {
            for (j = 0; j < vertices1 - 1; j++) {
                dist = SegmentoPuntoH(pieza2.coordX[i], pieza2.coordY[i], pieza1.coordX[j], pieza1.coordY[j], pieza1.coordX[j + 1], pieza1.coordY[j + 1]);
                if (dist < 0) {
                    continue;
                }
        ...
        for (i = 0; i < vertices2; i++) {
            dist = SegmentoPuntoH(pieza2.coordX[i], pieza2.coordY[i], pieza1.coordX[vertices1 - 1], pieza1.coordY[vertices1 - 1], pieza1.coordX[0], pieza1.coordY[0]);
            if (dist < 0) {
                continue;
            }
    ...
    private static int cercaniaVerPP(Piece pieza1, Piece pieza2) {
        ...
        for (i = 0; i < vertices1; i++) {
            for (j = 0; j < vertices2 - 1; j++) {
                dist = -SegmentoPuntoV(pieza1.coordX[i], pieza1.coordY[i], pieza2.coordX[j], pieza2.coordY[j], pieza2.coordX[j + 1], pieza2.coordY[j + 1]);
        ...
        for (i = 0; i < vertices1; i++) {
            dist = -SegmentoPuntoV(pieza1.coordX[i], pieza1.coordY[i], pieza2.coordX[vertices2 - 1], pieza2.coordY[vertices2 - 1], pieza2.coordX[0], pieza2.coordY[0]);
            if (dist < 0) {
                continue;
            }
            if (dist < minima) {
        ...
        for (i = 0; i < vertices2; i++) {
            for (j = 0; j < vertices1 - 1; j++) {
                dist = SegmentoPuntoV(pieza2.coordX[i], pieza2.coordY[i], pieza1.coordX[j], pieza1.coordY[j], pieza1.coordX[j + 1], pieza1.coordY[j + 1]);
                if (dist < 0) {
                    continue;
                }
                if (dist < minima) {
        ...
        for (i = 0; i < vertices2; i++) {
            dist = SegmentoPuntoV(pieza2.coordX[i], pieza2.coordY[i], pieza1.coordX[vertices1 - 1], pieza1.coordY[vertices1 - 1], pieza1.coordX[0], pieza1.coordY[0]);
            if (dist < 0) {
                continue;
            }
            if (dist < minima) {
    ...
    private static boolean posicionValida(Sheet objeto, Piece pieza) {
        ...
        if (pieza.getYmax() <= objeto.getYmax() && pieza.getXmax() <= objeto.getXmax() && pieza.getXmin() >= 0 && pieza.getYmin() >= 0) {
            ...
            if (!interseccionOP(objeto, pieza)) {

                return !dentroOP(objeto, pieza);
            }
        }
    ...
    private static boolean interseccionPP(Piece pieza1, Piece pieza2) {
        ...
        if ((pieza1.getXmax() <= pieza2.getXmin()) || (pieza2.getXmax() <= pieza1.getXmin()) || (pieza1.getYmax() <= pieza2.getYmin()) || (pieza2.getYmax() <= pieza1.getYmin())) {
            return false;
        }
        ...
        for (int i = 0; i < vertices1 - 1; i++) {
            for (int j = 0; j < vertices2 - 1; j++) {
                value = interseccionSS(pieza1.coordX[i], pieza1.coordY[i], pieza1.coordX[i + 1], pieza1.coordY[i + 1], pieza2.coordX[j], pieza2.coordY[j], pieza2.coordX[j + 1], pieza2.coordY[j + 1]);
                if (value) {
                    return true;
                }
            }
            ...
            value = interseccionSS(pieza1.coordX[i], pieza1.coordY[i], pieza1.coordX[i + 1], pieza1.coordY[i + 1], pieza2.coordX[vertices2 - 1], pieza2.coordY[vertices2 - 1], pieza2.coordX[0], pieza2.coordY[0]);
            if (value) {
                return true;
            }
        }
        ...
        for (int j = 0; j < vertices2 - 1; j++) {
            value = interseccionSS(pieza1.coordX[vertices1 - 1], pieza1.coordY[vertices1 - 1], pieza1.coordX[0], pieza1.coordY[0], pieza2.coordX[j], pieza2.coordY[j], pieza2.coordX[j + 1], pieza2.coordY[j + 1]);
            if (value) {
                return true;
            }
        }
        ...
        value = interseccionSS(pieza1.coordX[vertices1 - 1], pieza1.coordY[vertices1 - 1], pieza1.coordX[0], pieza1.coordY[0], pieza2.coordX[vertices2 - 1], pieza2.coordY[vertices2 - 1], pieza2.coordX[0], pieza2.coordY[0]);
        return value;
    }
    ...
    private static boolean interseccionSS(int X1, int Y1, int X2, int Y2, int X3, int Y3, int X4, int Y4) {
        ...
        if (X1 == X2) {
            if (Y3 == Y4) {
                if ((X1 < Math.max(X3, X4) && X1 > Math.min(X3, X4)) && (Y3 < Math.max(Y1, Y2) && Y3 > Math.min(Y1, Y2))) {
                    return true;
                }
            }
            ...
            return (y < Math.max(Y1, Y2) && y > Math.min(Y1, Y2)) && (y < Math.max(Y3, Y4) && y > Math.min(Y3, Y4));
        }


        if (X3 == X4) {
            if (Y1 == Y2) {
                if ((X3 < Math.max(X1, X2) && X3 > Math.min(X1, X2)) && (Y1 < Math.max(Y3, Y4) && Y1 > Math.min(Y3, Y4))) {
                    return true;
                }
            }
        ...
        return (x < Math.max(X1, X2) && x > Math.min(X1, X2)) && (x < Math.max(X3, X4) && x > Math.min(X3, X4));
    }
    ...
    public static boolean interseccionSP(int x1, int y1, int x2, int y2, Piece piezaOut) {
        ...
        for (int i = 0; i < vertices - 1; i++) {
            if (interseccionSS(x1, y1, x2, y2, piezaOut.coordX[i], piezaOut.coordY[i], piezaOut.coordX[i + 1], piezaOut.coordY[i + 1])) {
                return true;
            }
        }

        return interseccionSS(x1, y1, x2, y2, piezaOut.coordX[vertices - 1], piezaOut.coordY[vertices - 1], piezaOut.coordX[0], piezaOut.coordY[0]);
    }
    ...
    private static int adyacenciaOP(Sheet objeto, Piece piezaOut) {
        Piece pzaIn;
        int[] vertices = {0, 0, objeto.getXmax(), 0, objeto.getXmax(), objeto.getYmax(), 0, objeto.getYmax()};
    ...
    private static int adyacenciaPP(Piece pieza1, Piece pieza2) {
        ...
        for (int i = 0; i < vertices1 - 1; i++) {
            for (int j = 0; j < vertices2 - 1; j++) {
                adyacencia += adyacenciaSS(pieza1.coordX[i], pieza1.coordY[i], pieza1.coordX[i + 1], pieza1.coordY[i + 1], pieza2.coordX[j], pieza2.coordY[j], pieza2.coordX[j + 1], pieza2.coordY[j + 1]);
            }

            adyacencia += adyacenciaSS(pieza1.coordX[i], pieza1.coordY[i], pieza1.coordX[i + 1], pieza1.coordY[i + 1], pieza2.coordX[vertices2 - 1], pieza2.coordY[vertices2 - 1], pieza2.coordX[0], pieza2.coordY[0]);
        }


        for (int j = 0; j < vertices2 - 1; j++) {
            adyacencia += adyacenciaSS(pieza1.coordX[vertices1 - 1], pieza1.coordY[vertices1 - 1], pieza1.coordX[0], pieza1.coordY[0], pieza2.coordX[j], pieza2.coordY[j], pieza2.coordX[j + 1], pieza2.coordY[j + 1]);
        }


        adyacencia += adyacenciaSS(pieza1.coordX[vertices1 - 1], pieza1.coordY[vertices1 - 1], pieza1.coordX[0], pieza1.coordY[0], pieza2.coordX[vertices2 - 1], pieza2.coordY[vertices2 - 1], pieza2.coordX[0], pieza2.coordY[0]);
        return adyacencia;
    }
    ...
    private static int adyacenciaSS(int X1, int Y1, int X2, int Y2, int X3, int Y3, int X4, int Y4) {
        ...
        if (X1 == X2 && X3 == X4) {
            ...
            if ((Y1 <= Math.max(Y3, Y4)) && (Y1 >= Math.min(Y3, Y4)) && (Y2 <= Math.max(Y3, Y4)) && (Y2 >= Math.min(Y3, Y4))) {
        ...
        if (Y1 == Y2 && Y3 == Y4) {
            ...
            if ((X1 <= Math.max(X3, X4)) && (X1 >= Math.min(X3, X4)) && (X2 <= Math.max(X3, X4)) && (X2 >= Math.min(X3, X4))) {
    ...
    public static int adyacenciaSP(int x1, int y1, int x2, int y2, Piece piezaOut) {
        ...
        int distancia = 0;
        for (int i = 0; i < vertices - 1; i++) {
            distancia += adyacenciaSS(x1, y1, x2, y2, piezaOut.coordX[i], piezaOut.coordY[i], piezaOut.coordX[i + 1], piezaOut.coordY[i + 1]);
        }

        distancia += adyacenciaSS(x1, y1, x2, y2, piezaOut.coordX[vertices - 1], piezaOut.coordY[vertices - 1], piezaOut.coordX[0], piezaOut.coordY[0]);
    ...
    private static boolean dentroPP(Piece pieza1, Piece pieza2) {
        ...
        alto = Math.max(pieza1.getXmax(), pieza2.getXmax()) - Math.min(pieza1.getXmin(), pieza2.getXmin());
        ancho = Math.max(pieza1.getYmax(), pieza2.getYmax()) - Math.min(pieza1.getYmin(), pieza2.getYmin());
        ...
        for (int j = 0; j < vertices - 1; j++) {
            value = dentroPuntoPieza((pieza1.coordX[j] + pieza1.coordX[j + 1]) / 2, (pieza1.coordY[j] + pieza1.coordY[j + 1]) / 2, pieza2);
            if (value) {
                return true;
            }


            value = dentroPuntoPieza((pieza1.coordX[j] + pieza1.coordX[j + 1]) / 2 + 2, (pieza1.coordY[j] + pieza1.coordY[j + 1]) / 2 + 2, pieza1);
            if (value) {
                value = dentroPuntoPieza((pieza1.coordX[j] + pieza1.coordX[j + 1]) / 2 + 2, (pieza1.coordY[j] + pieza1.coordY[j + 1]) / 2 + 2, pieza2);
                if (value) {
                    return true;
                }
            }
        ...
        value = dentroPuntoPieza((pieza1.coordX[vertices - 1] + pieza1.coordX[0]) / 2, (pieza1.coordY[vertices - 1] + pieza1.coordY[0]) / 2, pieza2);
        if (value) {
            return true;
        }
        value = dentroPuntoPieza((pieza1.coordX[vertices - 1] + pieza1.coordX[0]) / 2 + 2, (pieza1.coordY[vertices - 1] + pieza1.coordY[0]) / 2 + 2, pieza1);
        if (value) {
            value = dentroPuntoPieza((pieza1.coordX[vertices - 1] + pieza1.coordX[0]) / 2 + 2, (pieza1.coordY[vertices - 1] + pieza1.coordY[0]) / 2 + 2, pieza2);
            if (value) {
                return true;
            }
        }
        ...
        value = dentroPuntoPieza((pieza1.getXmax() + pieza1.getXmin()) / 2, (pieza1.getYmax() + pieza1.getYmin()) / 2, pieza1);
        if (value) {
            value = dentroPuntoPieza((pieza1.getXmax() + pieza1.getXmin()) / 2, (pieza1.getYmax() + pieza1.getYmin()) / 2, pieza2);
            if (value) {
                return true;
            }
        }
        ...
        for (int j = 0; j < vertices2 - 1; j++) {
            value = dentroPuntoPieza((pieza2.coordX[j] + pieza2.coordX[j + 1]) / 2, (pieza2.coordY[j] + pieza2.coordY[j + 1]) / 2, pieza1);
            if (value) {
                return true;
            }


            value = dentroPuntoPieza((pieza2.coordX[j] + pieza2.coordX[j + 1]) / 2 + 2, (pieza2.coordY[j] + pieza2.coordY[j + 1]) / 2 + 2, pieza2);
            if (value) {
                value = dentroPuntoPieza((pieza2.coordX[j] + pieza2.coordX[j + 1]) / 2 + 2, (pieza2.coordY[j] + pieza2.coordY[j + 1]) / 2 + 2, pieza1);
                if (value) {
                    return true;
                }
            }
        ...
        value = dentroPuntoPieza((pieza2.coordX[vertices2 - 1] + pieza2.coordX[0]) / 2, (pieza2.coordY[vertices2 - 1] + pieza2.coordY[0]) / 2, pieza1);
        if (value) {
            return true;
        }
        value = dentroPuntoPieza((pieza2.coordX[vertices2 - 1] + pieza2.coordX[0]) / 2 + 2, (pieza2.coordY[vertices2 - 1] + pieza2.coordY[0]) / 2 + 2, pieza2);
        if (value) {
            value = dentroPuntoPieza((pieza2.coordX[vertices2 - 1] + pieza2.coordX[0]) / 2 + 2, (pieza2.coordY[vertices2 - 1] + pieza2.coordY[0]) / 2 + 2, pieza1);
            if (value) {
                return true;
            }
        }
        ...
        value = dentroPuntoPieza((pieza2.getXmax() + pieza2.getXmin()) / 2, (pieza2.getYmax() + pieza2.getYmin()) / 2, pieza2);
        if (value) {
            value = dentroPuntoPieza((pieza2.getXmax() + pieza2.getXmin()) / 2, (pieza2.getYmax() + pieza2.getYmin()) / 2, pieza1);
            return value;
        }
        return false;
    }
    ...
    private static boolean dentroPPV(Piece pieza1, PieceVirtual pieza2) {
        ...
        for (int j = 0; j < vertices - 1; j++) {
            value = dentroPuntoPiezaV((pieza1.coordX[j] + pieza1.coordX[j + 1]) / 2, (pieza1.coordY[j] + pieza1.coordY[j + 1]) / 2, pieza2);
            if (value) {
                return true;
            }
            value = dentroPuntoPieza((pieza1.coordX[j] + pieza1.coordX[j + 1]) / 2 + 2, (pieza1.coordY[j] + pieza1.coordY[j + 1]) / 2 + 2, pieza1);
            if (value) {
                value = dentroPuntoPiezaV((pieza1.coordX[j] + pieza1.coordX[j + 1]) / 2 + 2, (pieza1.coordY[j] + pieza1.coordY[j + 1]) / 2 + 2, pieza2);
                if (value) {
                    return true;
                }
            }
        ...
        value = dentroPuntoPiezaV((pieza1.coordX[vertices - 1] + pieza1.coordX[0]) / 2, (pieza1.coordY[vertices - 1] + pieza1.coordY[0]) / 2, pieza2);
        if (value) {
            return true;
        }
        value = dentroPuntoPieza((pieza1.coordX[vertices - 1] + pieza1.coordX[0]) / 2 + 2, (pieza1.coordY[vertices - 1] + pieza1.coordY[0]) / 2 + 2, pieza1);
        if (value) {
            value = dentroPuntoPiezaV((pieza1.coordX[vertices - 1] + pieza1.coordX[0]) / 2 + 2, (pieza1.coordY[vertices - 1] + pieza1.coordY[0]) / 2 + 2, pieza2);
            if (value) {
                return true;
            }
        }
        ...
        value = dentroPuntoPieza((pieza1.getXmax() + pieza1.getXmin()) / 2, (pieza1.getYmax() + pieza1.getYmin()) / 2, pieza1);
        if (value) {
            value = dentroPuntoPiezaV((pieza1.getXmax() + pieza1.getXmin()) / 2, (pieza1.getYmax() + pieza1.getYmin()) / 2, pieza2);
            if (value) {
                return true;
            }
        }
        ...
        for (int j = 0; j < vertices2 - 1; j++) {
            ...
            value = dentroPuntoPiezaV((pieza2.coordX[j] + pieza2.coordX[j + 1]) / 2 + 2, (pieza2.coordY[j] + pieza2.coordY[j + 1]) / 2 + 2, pieza2);
            if (value) {
                value = dentroPuntoPieza((pieza2.coordX[j] + pieza2.coordX[j + 1]) / 2 + 2, (pieza2.coordY[j] + pieza2.coordY[j + 1]) / 2 + 2, pieza1);
                if (value) {
                    return true;
        ...
        value = dentroPuntoPiezaV((pieza2.coordX[vertices2 - 1] + pieza2.coordX[0]) / 2 + 2, (pieza2.coordY[vertices2 - 1] + pieza2.coordY[0]) / 2 + 2, pieza2);
        if (value) {
            value = dentroPuntoPieza((pieza2.coordX[vertices2 - 1] + pieza2.coordX[0]) / 2 + 2, (pieza2.coordY[vertices2 - 1] + pieza2.coordY[0]) / 2 + 2, pieza1);
            if (value) {
                return true;
        ...
        value = dentroPuntoPiezaV((pieza2.getXmax() + pieza2.getXmin()) / 2, (pieza2.getYmax() + pieza2.getYmin()) / 2, pieza2);
        if (value) {
            value = dentroPuntoPieza((pieza2.getXmax() + pieza2.getXmin()) / 2, (pieza2.getYmax() + pieza2.getYmin()) / 2, pieza1);
            return value;
        }
    ...
    public static boolean dentroPuntoPieza(int x1, int y1, Piece pieza) {
        ...
        int dFun1, dFun2;
        boolean value;
        if (x1 <= pieza.getXmin() || x1 >= pieza.getXmax() || y1 <= pieza.getYmin() || y1 >= pieza.getYmax()) {
            return false;
        }


        for (int i = 0; i < vertices - 1; i++) {
            value = dentroPuntoSegm(x1, y1, pieza.coordX[i], pieza.coordY[i], pieza.coordX[i + 1], pieza.coordY[i + 1]);
            if (value) {
                return false;
            }
        }
        value = dentroPuntoSegm(x1, y1, pieza.coordX[vertices - 1], pieza.coordY[vertices - 1], pieza.coordX[0], pieza.coordY[0]);
        if (value) {
            return false;
        }
        ...
        for (int i = 0; i < vertices - 1; i++) {
            value = interseccionSS(x1, y1, numgrande, y1, pieza.coordX[i], pieza.coordY[i], pieza.coordX[i + 1], pieza.coordY[i + 1]);
            if (value) {
                contador++;
            }
        }

        value = interseccionSS(x1, y1, numgrande, y1, pieza.coordX[vertices - 1], pieza.coordY[vertices - 1], pieza.coordX[0], pieza.coordY[0]);
        if (value) {
            contador++;
        }
        ...
        for (int i = 0; i < vertices; i++) {
            ...
            value = (dentroPuntoSegm(pieza.coordX[i], pieza.coordY[i], x1, y1, numgrande, y1) && (x1 != pieza.coordX[i] || y1 != pieza.coordY[i]));

            if (value) {

                if (i == 0) {
                    dFun1 = ArrayOperations.dFunction(pieza.coordX[vertices - 1], pieza.coordY[vertices - 1], x1, y1, numgrande, y1);
                } else {
                    dFun1 = ArrayOperations.dFunction(pieza.coordX[i - 1], pieza.coordY[i - 1], x1, y1, numgrande, y1);
                }

                if (i == vertices - 1) {
                    dFun2 = ArrayOperations.dFunction(pieza.coordX[0], pieza.coordY[0], x1, y1, numgrande, y1);
                } else {
                    dFun2 = ArrayOperations.dFunction(pieza.coordX[i + 1], pieza.coordY[i + 1], x1, y1, numgrande, y1);
                }
    ...
    public static boolean tangenteSegmPieza(int X1, int Y1, int X2, int Y2, Piece pza) {
        ...
        for (int i = 0; i < vertices; i++) {
            Xpza = pza.coordX[i];
            Ypza = pza.coordY[i];
            if (distPuntoPunto(X2, Y2, Xpza, Ypza) + distPuntoPunto(X1, Y1, Xpza, Ypza) == distPuntoPunto(X1, Y1, X2, Y2) && (X2 != Xpza && Y2 != Ypza) && (X1 != Xpza && Y1 != Ypza)) {
                return true;
            }
        }
    ...
    private static boolean dentroPuntoSegm(int X1, int Y1, int X2, int Y2, int X3, int Y3) {
        return distPuntoPunto(X1, Y1, X2, Y2) + distPuntoPunto(X1, Y1, X3, Y3) == distPuntoPunto(X2, Y2, X3, Y3);
    }
